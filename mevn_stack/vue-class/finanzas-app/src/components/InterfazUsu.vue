    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">Ingresos</a></li>
          <li><a class="nav-link scrollto" href="#services">Egresos</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Consolidado</a></li>
